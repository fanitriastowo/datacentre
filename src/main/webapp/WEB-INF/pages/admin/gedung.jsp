...
<h2>Daftar Gedung</h2>
<a class="btn btn-primary" href='<spring:url value="/pages/admin/cetak/gedung.html" />'>Cetak</a>
<br />
<br />
		...
		<tbody>
			<c:forEach items="${gedungList }" var="gedung">
				<tr>
					...
					<td>
						<a href='<spring:url value="/pages/admin/detail/${gedung.id }.html" />' class="btn btn-info">Detail</a> 
